    ...
    <div className="mobile-container">
      <div className="nav-header sticky top-0 z-10 py-4 mb-6">
        <div className="flex items-center justify-between mb-3">
          ...
          <span className="text-primary font-medium text-sm">已完成</span>
        </div>
      ...
      <div className="text-center py-12">
        <div className="mb-8">
          <div className="w-24 h-24 mx-auto rounded-full bg-gradient-to-br from-green-500/20 to-emerald-500/20 border-2 border-green-500/50 flex items-center justify-center animate-pulse">
        ...
        {isSubmitted && (
          <>
            ...
            <div className="bg-amber-500/20 border border-amber-500/50 rounded-lg p-4 max-w-xs mx-auto">
        ...
        <div className="mt-12 text-slate-500 text-sm">
          <p>如有疑问，请联系主试</p>
          <p className="text-slate-400 mt-1">微信：CHEL_7777</p>
        </div>
      </div>
    </div>
  );
