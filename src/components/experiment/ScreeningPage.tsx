    ...
    <div className="mobile-container">
      <div className="nav-header sticky top-0 z-10 py-4 mb-6">
        <div className="flex items-center justify-between mb-3">
          ...
          <span className="text-blue-400 font-medium text-sm">筛选问卷</span>
        </div>
      ...
      <div className="glass-card p-6 mb-6">
        ...
        <p className="text-white/60 text-sm mb-6">请仔细阅读并回答以下问题</p>
      ...
      <button onClick={handleSubmit} className="btn-primary ripple">
        提交答案
      </button>
    </div>
  );
