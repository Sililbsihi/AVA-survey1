...
export async function POST(request: NextRequest) {
  try {
    ...
    const row: Record<string, unknown> = {
      ...
      phone: body.phone, education: body.education,
      ...
      q9: body.q9, q10: body.q10, q11: body.q11, q12: body.q12,
      q13: body.q13, q14: body.q14, q15: body.q15, q16: body.q16,
      q17: body.q17,
      scenario_order: Array.isArray(body.scenarioOrder) ? body.scenarioOrder.join(',') : (body.scenarioOrder || ''),
